...
const sortDataByDesc = () => {
  return axios.get(
    "https://breakable-trench-coat-deer.cyclic.app/pets/birds?sortBy=desc"
  );
 };

 const sortDataByAsc = () => {
  return axios.get(
    "https://breakable-trench-coat-deer.cyclic.app/pets/birds?sortBy=asc"
  );
 };
...
const Birdspage = () => {
  const [loading,setLoading]=useState(false)
    ...
    const catproduct=()=>{
        ...
        axios.get("https://breakable-trench-coat-deer.cyclic.app/pets/birds")
        .then((res)=>{
