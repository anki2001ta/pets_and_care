...
// sorting data by desc  and asc
const sortDataByDesc = () => {
  return axios.get(
    "https://breakable-trench-coat-deer.cyclic.app/pets/rabbits?sortBy=desc"
  );
 };

 const sortDataByAsc = () => {
  return axios.get(
    "https://breakable-trench-coat-deer.cyclic.app/pets/rabbits?sortBy=asc"
  );
 };
...
const Rabbitspage = () => {
  const [loading,setLoading]=useState(false)
    ...
    const catproduct=()=>{
        ...
        axios.get("https://breakable-trench-coat-deer.cyclic.app/pets/rabbits")
        .then((res)=>{
    ...
    <div className='Product_page'>
        ...
        <div className='Product_br'>
         <div className='Product_g'>
            <h3 id="title">BUNNIES HERE</h3>
            <div className='functi'>
            <h2 id="title2">SORT BY PRICES</h2>
            <button class="button-73" onClick={handlesortByDesc}>PRICE: HIGH TO LOW</button>
            <button class="button-73" onClick={handlesortByAsc}>PRICE: LOW TO HIGH</button>
            </div>
         </div>
